<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">สมัครตัวแทนจำหน่าย</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<div class="row">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label for="district" class="col-lg-3 control-label">ตำบล</label>
                                <div class="col-lg-5">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label for="tax_district" class="col-lg-3 control-label">ตำบล</label>
                                <div class="col-lg-5">
...
<script type="text/javascript">
    $(function() {
        ...
        var options = {
            url: base_url + index_page + 'authentication/result_auth/register',
    ...
    function showResponse(response, statusText, xhr, $form) {
        ...
        if (as.error.status === false) {
            ...
            $('body').on('click', '#myModal #button-ok', function() {
                window.location.href = base_url + index_page + 'authentication/auth/login';
            });
