    <div class="inner-bg">
    	<div class="container">
    		<div class="row">
              ...
              <div class="form-group">
              <div class="col-sm-offset-3 col-sm-9">
                  <a href="<?php echo site_url(); ?>users/profile/edit" class="btn btn-default btn-lg active" role="button">แก้ไข</a>
              </div>
              <p>&nbsp;</p>
              <hr />
              <div class="form-group">
                <label for="branch_id" class="col-sm-3 control-label">Course Information</label>
                <div class="col-sm-9">
