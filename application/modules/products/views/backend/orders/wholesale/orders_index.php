                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_1">
                        <thead>
                            <tr>
                                ...
                                <th width="5%" class="text-center">Couter</th>
                                <th width="8%" class="text-center">ยอดชำระ</th>
                                <th width="15%" class="text-center">ขนส่ง</th>
                                <th width="15%" class="text-center">ผู้รับเรื่อง</th>
    ...
    $(function() {
        ...
        var oTable = $('#sample_1').dataTable({
            ...
            "aoColumns": [
                ...
                {"mData": "orders_code"},
                {"mData": "company"},
                {"mData": "order_counter", "sClass": "text-center"},
