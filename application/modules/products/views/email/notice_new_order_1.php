                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td align="center" st-image="banner-image">
                                                        <div class="imgpop">
                                                            <a target="_blank" href="#"><img width="600" border="0" height="300" alt="" border="0" style="display:block; border:none; outline:none; text-decoration:none;" src="<?php echo base_url(); ?>assets/email/wooshi/img/new_pro.jpg" class="banner"></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </tbody>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #4f5458; text-align:left; line-height: 20px;">
                                                                        <p><strong>เลขที่สั่งซื้อ</strong> : <?php echo $order_code; ?></p>
                                                                        <p><strong>วันที่สั่งซื้อ</strong> : <?php echo $created_at; ?></p>
                                                                        <p><strong>ยอดที่ต้องชำระ</strong> : <?php echo number_format($total); ?> บาท</p>
                                                                        <p><strong>ช่องทางชำระ</strong> : 
                                                                            <?php
                                                                        ...
                                                                        <p><strong>ดูรายการสั่งซื้อ</strong> : <?php echo $link; ?></p>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    ...
                                                    <td>
                                                        <table width="290" align="left" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                                                            <tbody>
                                                                ...
                                                                <!-- Spacing -->
                                                                <tr>
                                                                    <td style="font-family: Helvetica, arial, sans-serif; font-size: 18px; color: #ffffff; text-align:left;">บริษัท อินไซด์ ไอที ดิสทริบิวชั่น จำกัด</td>
                                                                </tr>
                                                                <!-- Spacing -->
                                                                <tr>
                                                                    <td width="100%" height="10"></td>
                                                                ...
                                                                <!-- Spacing -->
                                                                <tr>
                                                                    <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #ffffff; text-align:left;">เลขที่ 801/70-72 ม.8 ถ.พหลโยธิน ต.คูคต อ.ลำลูกกา จ.ปทุมธานี 12130</td>
                                                                </tr>
                                                                <!-- Spacing -->
                                                                <tr>
                                                                    <td width="100%" height="10"></td>
                                                        ...
                                                        <table width="200" align="right" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                                                            <tbody>
                                                                ...
                                                                <!-- Spacing -->
                                                                <tr>
                                                                    <td style="font-family: Helvetica, arial, sans-serif; font-size: 18px; color: #ffffff; text-align:left;">ติดต่อเรา</td>
                                                                </tr>
                                                                <!-- Spacing -->
                                                                <tr>
                                                                    <td width="100%" height="10"></td>
                                                                ...
                                                                <!-- Spacing -->
                                                                <tr>
                                                                    <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #ffffff; text-align:left;">เบอร์ติดต่อ 02-992-5000<br />แฟกซ์ 02-992-5300<br />โทรศัพท์ 094-480-1851 ถึง 53<br />อีเมล์ sale.inside.it@gmail.com</td>
                                                                </tr>
                                                                <!-- Spacing -->
                                                                <tr>
                                                                    <td width="100%" height="20"></td>
