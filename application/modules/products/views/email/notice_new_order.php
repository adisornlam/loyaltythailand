...
<html>
    <head>
        ...
        <style type="text/css">
            ...
            .box_header{background: #DDD; padding: 5px; margin: 5px 0; text-align: center; font-weight: bold;}
        </style>
    </head>
    <body>
            ...
            <div style="padding:5px;">
                <table cellpadding="2" cellspacing="2" width="100%" border="0">
                    <tr>
                        ...
                        <td valign="top" width="33%"><h2 align="center">ใบสั่งซื้อสินค้า <?php //echo $item->orders_code;                                          ?></h2></td>
                        <td valign="top" style=" padding-top: 35px;">
                            ...
                            <table cellpadding="2" cellspacing="2" width="100%" border="0" style="border-collapse:collapse; margin-top: 20px; font-size: 9pt;">
                                <tr>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div  style="
                             border-color: #ddd; margin-bottom: 20px;
                                        ...
                                        <tbody style="display: table-row-group;
                                            ...
                                            <?php endforeach; ?>
                                              <tr style="border-top: 2px solid #333;">
                                                <td style=" text-align: right;" colspan="4"><strong>รวมราคา</strong></td>
                                                <td ><?php echo number_format($item->total_price); ?></td>
                                            </tr>
                                            <tr>
                                                <td style=" text-align: right;" colspan="4"><strong>ยอดชำระสินค้าทั้งหมด</strong></td>
                                                <td ><?php echo number_format($item->sum_price); ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                ...
                <div class="box_header">วิธีการชำระเงินค่าสินค้า</div>
                ...
                <div class="box_header">ยืนยันการชำระเงินค่าสินค้า</div>
                <div class="row" style="padding: 2px 20px;">
                    <?php
                    echo $info_1;
                    ?>
                </div>
                <div class="box_header">การตรวจสอบการชำระเงินค่าสินค้า</div>
                <div class="row" style="padding: 2px 20px;">
                    <?php
                    echo $info_2;
                    ?>
