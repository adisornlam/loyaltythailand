            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="pull-right">
                        <button class="btn btn-default btn-circle" type="button" id="btnRefresh" value="products/order"><i class="fa fa-refresh"></i>
                        </button>
                    </div>
                </div>                
            </div>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_1">
                        <thead>
                            <tr>
                                ...
                                <th width="7%" class="text-center">ยอดชำระ</th>
                                <th width="20%" class="text-center">ขนส่ง</th>
                                <th width="15%" class="text-center">วันที่ซื้อ</th>
...
<script type="text/javascript">
    $(function() {
        ...
        var oTable = $('#sample_1').dataTable({
            ...
            "ajax": {
                "url": base_url + index_page + "products/result_order/listall",
                "type": "POST",
                "data": function(d) {
    ...
    $('body').on('click', '.btnPayment', function() {
        load_page();
        var data = {
            url: 'products/order/transfer_add/' + $(this).attr('id'),
            title: 'แจ้งชำระเงิน'
        };
        genModal(data);
    });
