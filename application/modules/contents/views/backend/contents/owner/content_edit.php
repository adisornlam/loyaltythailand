            ...
            <div class="panel panel-default">
                <div class="panel-body"> 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <?php echo form_dropdown('group_id', $group, $item->group_id, 'class="form-control" id="group_id"'); ?>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <?php echo form_input('links', $item->links, 'class="form-control" id="links" placeholder="http://"'); ?>
                        </div>
                    </div>
                    <div class="form-group">
...
<script type="text/javascript">
    $(function () {
        ...
        var options = {
            url: base_url + index_page + 'contents/backend/result_content/edit',
