            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">      
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control tagsinput" id="product_id" name="product_id" value="<?php echo $item->product_id; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            ...
                            <label class="radio-inline">
                                <?php echo form_radio('position', 2, ($item->position == 2 ? TRUE : FALSE)); ?> Right
                            </label>
                            <label class="radio-inline">
                                <?php echo form_radio('position', 3, ($item->position == 3 ? TRUE : FALSE)); ?> Grid
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
