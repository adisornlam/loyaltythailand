                ...
                <div class="col-xs-12">
                  <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Couse Search</h3>
                    </div>
                    <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="pull-right">
                                <a href="<?php echo base_url().index_page(); ?>tutor/course/add" class="btn btn-primary" role="button" title="Add Couse"><li class="fa fa-plus"></li> Add Couse</a>
                            </div>
                        </div>
                    </div>
                </div>
