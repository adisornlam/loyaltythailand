    ...
    <div class="box box-info">
      ...
      <form class="form-horizontal">
        <div class="box-body">
          ...
          <div class="form-group">
          <label class="col-sm-1 control-label">Full score</label>
            <p class="form-control-static"><?php echo $item->full_score; ?></p>
          </div>
        </div>
          ...
          <table class="table table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><?php echo cal_math1($item2->score, $item->full_score); ?></td>
              </tr>
              <?php $i++; } ?>
            </tbody>
          </table>
