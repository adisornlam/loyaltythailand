					...
					<table class="table table-bordered">
						<thead>
							...
							<tr>
								...
								{
									$full_score1 = $this->Quiz_model->get_full_score_item($item->course_id, $course_sub_item2->id,1);
									$full_score2 = $this->Quiz_model->get_full_score_item($item->course_id, $course_sub_item2->id,2);
									echo '<th class="text-center">'.$full_score1.'</th>';
									echo '<th class="text-center">'.$full_score2.'</th>';
								}
								?>
