<div class="row">
    <div class="col-xs-12">
      <div class="box">
        ...
        <div class="box-body">
            <form class="form-horizontal" method="post" id="form-search" action="<?php echo base_url().index_page(); ?>tutor/report/checkname_export">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var oTable = $('#student_listall').dataTable({
            ...
            "deferLoading": 0,
            "ajax": {
                "url": site_url + "tutor/report/checkname_listall",
                "type": "POST",
                "data": function (d) {
