    ...
    <div class="col-lg-12">
        <div class="panel panel-default borderless">
            <div class="panel-body">
                <div class="pull-left">
                    <a href="<?php echo base_url() . index_page(); ?>users/backend/user/add" class="btn btn-primary btn-sm" role="button" title="Add Users (Dealer)"><li class="fa fa-plus"></li> Add Users</a>                    
                </div>  
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#sample_1').dataTable({
            ...
            "ajax": {
                "url": base_url + index_page + "users/backend/result_user_wholesale/listall",
                "type": "POST",
                "data": {group_id: 10}
            },
            "aoColumns": [
