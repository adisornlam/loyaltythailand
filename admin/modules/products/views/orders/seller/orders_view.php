...
<div class="row">
    <div class="col-lg-12">
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li class="active"><a href="#tab-0" role="tab" data-toggle="tab">ลูกค้า</a></li>
            <li><a href="#tab-1-1" role="tab" data-toggle="tab">สินค้า</a></li>
            <li><a href="#tab-1" role="tab" data-toggle="tab">สถานะ</a></li>
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="tab-0">
                <div class="panel-body">
                    <p>ชื่อ-นามสกุล : <?php echo $item->first_name . " " . $item->last_name; ?></p>
                    <p>เบอร์ติดต่อ : <?php echo $item->phone; ?></p>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                <tbody>
                                    ...
                                    foreach ($prod as $items):
                                        ...
                                        <tr>
                                            <td class="text-center vert-align">
                                                <a href="<?php echo base_url() . index_page(); ?>products/<?php echo $items['product_id']; ?>/<?php echo $items['cnt_title']; ?>" target="_blank" title="ดูรายละเอียดสินค้า"><img src="<?php echo get_thumbs($items['product_id']); ?>" width="100" class="img-thumbnail" /></a>
                                            </td>
                                            <td class="vert-align text-center"><?php echo $items['product_code']; ?></td>
                                            <td class="vert-align">                                        
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right"><?php echo number_format($item->sum_price); ?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div> 
                        ...
                        <div class="panel-body">
                            ...
                            <?php foreach ($order_log->result() as $value) { ?>
                                <div class="bs-callout bs-callout-info">
                                    ...
                                    <?php echo ((isset($value->tf_name) && ( $value->status == 'notified')) ? '<p>ชื่อผู้โอน: ' . $value->tf_name . '</p> <p>จำนวนเงิน: ' . number_format($value->tf_total) . ' บาท</p> <p>วันเวลา: ' . $value->fdate . ' ' . $value->ftime . '</p> <p>โอนจาก: ' . $value->from_bank . ' โอนเข้า: ' . $value->to_bank . '</p> <p>หลักฐานการโอนเงิน: ' . ($value->slip ? '<a href="' . base_url() . $value->slip . '" target="_blank">แสดงหลักฐาน</a>' : NULL) . '</p> <p>หมายเหตุ: ' . $value->tf_remark . '</p>' : NULL); ?>
                                    </a>
                                </div>
                            <?php } ?>
    ...
    <div class="col-lg-12">
        <div class="panel-body">
            <div class="text-center">                
                <a href="javascript:;" class="btn btn-danger btn-lg link_dialog" role="button" rel="products/backend/order/change_status/<?php echo $this->uri->segment(5); ?>" title="เปลียนสถานะ">
                    <i class="fa fa-check-circle"></i> เปลี่ยนสถานะ</a>  
                <a href="<?php echo base_url() . index_page(); ?>products/backend/order/prints/<?php echo $this->uri->segment(5); ?>" class="btn btn-success btn-lg" role="button" target="_blank" title="พิมพ์ใบสั่งซื้อ">
