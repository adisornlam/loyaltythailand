                            ...
                            <li class="dropdown user user-menu">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-footer">
                                        <div class="pull-left">
                                            <a href="<?php echo site_url(); ?>setting/users/profile" class="btn btn-default btn-flat"><i class="fa fa-id-card" aria-hidden="true"></i>
 Profile</a>
                                            <a href="<?php echo base_url(); ?>index.php/store/my/<?php echo $this->Store_model->get_store_name(); ?>" class="btn btn-default btn-flat" target="_blank"><i class="fa fa-shopping-bag" aria-hidden="true"></i>
 Store</a>
                                        </div>
                                        <div class="pull-right">
                                            <a href="<?php echo site_url(); ?>logout" class="btn btn-default btn-flat"><i class="fa fa-sign-out" aria-hidden="true"></i>
 Sign out</a>
                                        </div>
                                    </li>
                                </ul>
